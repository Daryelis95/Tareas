...
class ap_DevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'Tareas', 'user' => 'root', 'password' => 1234, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array(), 'driverClass' => 'Doctrine\\DBAL\\Driver\\MsSql\\Driver', 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5e70186db979e1.75398365')), true);
